...
*/
(function(){
	var TapTimes = 0,TapTimeout,LongTimeout,LastDirect = '';//定义全局变量
	...
	var Touch = function(obj){
		...
		_this.obj.addEventListener('touchstart',function(event){_this.touchStart(event)},false);
		_this.obj.addEventListener('touchmove',function(event){_this.touchMove(event)},false);
		_this.obj.addEventListener('touchend',function(event){_this.touchEnd(event)},false);
		_this.obj.addEventListener('touchcancel',function(event){_this.touchCancel(event)},false);
		
		_this.obj.addEventListener('gesturestart',function(event){_this.gestureStart(event)},false);
		_this.obj.addEventListener('gesturechange',function(event){_this.gestureChange(event)},false);
		_this.obj.addEventListener('gestureend',function(event){_this.gestureEnd(event)},false);
	};
	Touch.prototype = {
